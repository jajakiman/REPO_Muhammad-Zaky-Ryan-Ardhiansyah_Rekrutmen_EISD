...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::patch('/kampus/{campus}/status', [CampusController::class, 'status'])->name('campuses.status');
        ...
        Route::patch('/kampus/{campus}/area/{area}/status', [CampusAreaController::class, 'status'])->name('campuses.areas.status');
        ...
        Route::patch('/kampus/{campus}/area/{area}/lokasi/{location}/status', [CampusLocationController::class, 'status'])->name('campuses.areas.locations.status');
        ...
        Route::patch('/fasilitas/{feature}/status', [AccessibilityFeatureController::class, 'status'])->name('features.status');
        ...
        Route::patch('/kategori-masalah/{issue_category}/status', [IssueCategoryController::class, 'status'])->name('issue-categories.status');
        ...
        Route::patch('/petugas/{officer}/status', [OfficerAccountController::class, 'status'])->name('officers.status');
    });
});
